...
interface IframeChatWidgetProps {
  className?: string;
  position?: 'right' | 'left';
}

const IframeChatWidget: React.FC<IframeChatWidgetProps> = ({ 
  className = '', 
  position = 'right'
}) => {
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Онлайн чат</h3>
                    <p className="text-sm text-gray-500">Поддержка клиентов</p>
                  </div>
                </div>
                <button
